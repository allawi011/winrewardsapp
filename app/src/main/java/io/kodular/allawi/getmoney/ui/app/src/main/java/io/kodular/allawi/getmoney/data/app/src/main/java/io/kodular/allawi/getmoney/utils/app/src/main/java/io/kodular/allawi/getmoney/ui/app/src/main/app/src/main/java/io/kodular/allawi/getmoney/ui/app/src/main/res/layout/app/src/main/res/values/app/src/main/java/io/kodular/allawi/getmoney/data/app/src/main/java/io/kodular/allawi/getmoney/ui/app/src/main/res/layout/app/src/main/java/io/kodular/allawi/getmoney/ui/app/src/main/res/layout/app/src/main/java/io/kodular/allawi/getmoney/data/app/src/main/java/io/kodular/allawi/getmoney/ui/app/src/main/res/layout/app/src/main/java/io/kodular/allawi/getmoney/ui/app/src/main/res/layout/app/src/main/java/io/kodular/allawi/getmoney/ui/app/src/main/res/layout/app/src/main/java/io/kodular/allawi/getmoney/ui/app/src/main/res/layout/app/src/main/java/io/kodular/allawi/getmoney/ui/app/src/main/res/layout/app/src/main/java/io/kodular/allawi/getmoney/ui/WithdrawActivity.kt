...
class WithdrawActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSend.setOnClickListener { sendWithdraw() }
    }
    ...
    private fun sendWithdraw() {
        ...
        db.collection("users").document(uid).get().addOnSuccessListener { doc ->
            ...
            if (points < pointsNeed) {
                Toast.makeText(this, "لا تملك نقاط كافية (1000 نقطة = 1$)", Toast.LENGTH_SHORT).show()
            ...
            db.collection("withdraws").add(data).addOnSuccessListener {
                Toast.makeText(this, "تم ارسال طلب السحب ✅", Toast.LENGTH_SHORT).show()
            }
        }
    }
}
